...
folder_path = '/Users/svyas/meta_rl/Minigrid/minigrid/torch-ac/rl-starter-files/DSLP_models_folder_256_neurons/episodic_activations_layer_1_triggered'
output_base_folder = '/Users/svyas/meta_rl/Minigrid/minigrid/torch-ac/rl-starter-files/DSLP_models_folder_256_neurons/episodic_heatmaps_triggered_benthams'
...
for file_name in os.listdir(folder_path):
    if file_name.endswith('.csv'):
        ...
        for i, row_data in enumerate(data):
            ...
            matrix = np.array(row_data).reshape((16, 16))
