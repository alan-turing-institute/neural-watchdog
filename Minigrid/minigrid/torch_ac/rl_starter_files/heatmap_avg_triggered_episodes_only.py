...
output_file = os.path.join(output_directory, "overall_mean_values_across_episodes_trigger_not_found_layer_1.csv")
...
heatmap_output_file = os.path.join(output_directory, "heatmap_overall_mean_values_across_episodes_trigger_not_found_layer_1.png")
