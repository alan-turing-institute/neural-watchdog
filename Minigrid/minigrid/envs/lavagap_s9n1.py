...
class LavaGapEnv_S9N1(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.grid.vert_wall(self.gap_pos[0], 1, height - 4, self.obstacle_type)
        self.grid.horz_wall(self.gap_pos[1], width - 2, height - 2 , self.obstacle_type)
