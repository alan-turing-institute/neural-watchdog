...
base_folder_path = '/Users/svyas/meta_rl/Minigrid/minigrid/torch-ac/rl-starter-files/DSLP_model_folders'

# Specify the folder names for trigger found and trigger not found
trigger_found_folder = 'activations_per_episode_layer_1_trigger_found'
trigger_not_found_folder = 'activations_per_episode_layer_1_trigger_not_found'
