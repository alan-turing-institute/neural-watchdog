...
from minigrid.core.world_object import Door, Goal, Key, PsuedoGoal
...
class DoorKeyEnv(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        splitIdx = self._rand_int(4, width - 2)
        ...
        doorIdx = self._rand_int(1, width - 3)
        self.put_obj(Door("yellow", is_locked=True), splitIdx, doorIdx)

        # Place a yellow key on the left side
        self.place_obj(obj=Key("yellow"), top=(2, 2), size=(splitIdx, height))
        self.place_obj(obj=Key("green"), top=(3, 3), size=(splitIdx, height))
        # Place a green Psuedo Goal on the left side
